...
public class FrogScript : MonoBehaviour
{
	...
	{
		//If he's moving, he hasn't seen you.
			m_Animator.SetBool ("HasSeenYou", false);
		//which way should he be walking
			if (!turnAround) {
				//Debug.Log ("to right");
				...
				//Debug.Log ("to left");
				m_NextMovement.x -= movement.x;	
				//m_NextMovement.y += movement.y;
				//m_SpriteRenderer.flipX = true;
				//Debug.Log (m_SpriteRenderer.flipX);
			}

//		Debug.Log ("Within method");
	}
	...
	void OnCollisionEnter2D(Collision2D coll)
	{
		...
		//if you hit a boulder, don't push it.
